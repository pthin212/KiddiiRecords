                    ...
                    <div class="form-row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="sk_tacgia" class="form-control">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="sk_ngay">Ngày:</label>
                                <input type="text" name="sk_ngay" class="form-control">
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <lable for="">Nội dung:</label>
                        <textarea id="sk_noidung" name="sk_noidung" class="form-control"></textarea>
                    </div>
                    <div class="form-group">
                        <label for="sk_duongdan">Đường dẫn:</label>
                        <input type="text" name="sk_duongdan" class="form-control">
                    </div>
                    <div class="form-group">
    ...
    <?php
        if(isset($_POST['btnLuu'])){
            ...
            if(!empty($_FILES['sk_hinhanh']['name'])){   
                ...
                //luu vao database
                $sqlInsert = "INSERT INTO sukien(sk_hinhanh,sk_noidung,sk_tacgia,sk_ngay,sk_duongdan) VALUES('$newFileName','$sk_noidung','$sk_tacgia','$sk_ngay','$sk_duongdan')";
