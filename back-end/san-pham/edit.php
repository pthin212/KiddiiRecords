        ...
        <div class="row pb-2">
            ...
            <div class="col-10 mt-2">
                ...
                <?php
                    //Lay du lieu cu
                    $sp_id=$_GET['sp_id'];
                    $sqlSelectSanPhamCu = "SELECT * FROM sanpham WHERE sp_id=$sp_id;";
                ...
                <form name="frmThemMoi" id="frmThemMoi"method="POST" action="">
                    <div class="form-group">
                        ...
                        <input type="text" name="sp_ten" class="form-control" value="<?= $dataSanPhamCu['sp_ten']?>">
                    </div>
                    <div class="form-row">
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="sp_giagoc">Giá gốc:</label>
                                <input type="number" name="sp_giagoc" class="form-control" value="<?= $dataSanPhamCu['sp_giagoc']?>">
                            </div>
                        </div>
                        <div class="col-md-9">
                            <div class="form-group">
                                ...
                                <select name="km_id" class="form-control">
                                    <?php foreach($dataKhuyenMai as $index => $km):?>
                                        <?php if($index==0):?>
                                            <?php if($km['km_id'] == $dataSanPhamCu['km_id']):?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="sp_soluong" name="sp_soluong" class="form-control" value="<?= $dataSanPhamCu['sp_soluong']?>">
                    </div>
                    <div class="form-group">
                        <lable for="">Mô tả:</label>
                        <textarea id="sp_mota" name="sp_mota" class="form-control"><?= $dataSanPhamCu['sp_mota']?></textarea>
                    </div>
                    <div class="row">
                        <div class="col-4">
                            <div class="form-group">
                                ...
                                <select name="dd_id" class="form-control">
                                    <?php foreach($dataDinhDang as $dd):?>
                                        <?php if($dd['dd_id'] == $dataSanPhamCu['dd_id']):?>
                                            <option value="<?=$dd['dd_id']?>" selected>
                                                <?=$dd['dd_ten']?>
                                            </option>
                                        <?php else:?>
                            ...
                            <div class="form-group">
                                ...
                                <select name="ns_id" class="form-control">
                                    <?php foreach($dataNgheSi as $ns):?>
                                        <?php if($ns['ns_id'] == $dataSanPhamCu['ns_id']):?>
                                            <option value="<?=$ns['ns_id']?>" selected>
                                                <?=$ns['ns_ten']?>
                                            </option>
                                        <?php else:?>
                        ...
                        <div class="col-4">
                            <div class="form-group">
                                ...
                                <select name="sp_trending" class="form-control">
                                    <?php if($dataSanPhamCu['sp_trending']==0):?>
                                        <option value=0 selected>Không</option>
                                    <?php else:?>
                                        <option value=0>Không</option>
                                    <?php endif;?>

                                    <?php if($dataSanPhamCu['sp_trending']==1):?>
